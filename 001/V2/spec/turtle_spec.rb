...
describe "9-turtle-tracks" do
  ...
  describe "processes commands" do
    ...
    describe "on an 11x11 grid" do
      ...
      it "calls forward method for FD command" do
...
GRID
      ...
      describe "FD x: tells the turtle to move forward by x units" do
...
GRID
      ...
      describe "RT x: change the turtle's current orientation by x degrees clockwise" do
        ...
        it "calls right method for RT command" do
          turtle.should_receive(:right).with(45,[])
          turtle.command('RT 45')
        end

        it "starting at orientation 0 turns right by 45 degrees" do
          turtle.orientation=0
          turtle.command('RT 45')
          turtle.orientation.should == 45
        end

        it "starting at orientation 0 turns right by 90 degrees" do
          turtle.orientation=0
          turtle.command('RT 90')
          turtle.orientation.should == 90
        end

        it "starting at orientation 45 turns right by 90 degrees" do
          turtle.orientation=45
          turtle.command('RT 90')
          turtle.orientation.should == 135
        end

        it "starting at orientation 315 turns right by 90 degrees" do
          turtle.orientation=315
          turtle.command('RT 90')
          turtle.orientation.should == 45
        end
      ...
      describe "LT x: change the turtle's current orientation by x degrees counter-clockwise" do
        ...
        it "calls right method for LT command" do
          turtle.should_receive(:left).with(45,[])
          turtle.command('LT 45')
        end

        it "starting at orientation 0 turns left by 45 degrees" do
          turtle.orientation=0
          turtle.command('LT 45')
          turtle.orientation.should == 315
        end

        it "starting at orientation 0 turns left by 90 degrees" do
          turtle.orientation=0
          turtle.command('LT 90')
          turtle.orientation.should == 270
        end

        it "starting at orientation 315 turns left by 90 degrees" do
          turtle.orientation=315
          turtle.command('LT 90')
          turtle.orientation.should == 225
        end

        it "starting at orientation 45 turns left by 90 degrees" do
          turtle.orientation=45
          turtle.command('LT 90')
          turtle.orientation.should == 315
        end
      ...
      describe "BK x: tells the turtle to move backwards by x units, keeping its current orientation" do

        it "calls backward method for BK command" do
          turtle.should_receive(:backward).with(5,[])
          turtle.command('BK 5')
        end
